...
public class CDatePicker extends TextView
{
	...
	public CDatePicker(Context context, UIItem item, Fields data,final Handler handler)
	{
		super(context);
		this.data = data;
		this.item = item;
	...
	class showDatePicker implements OnClickListener
	{
		...
		public void onClick(View v)
		{
			...
			final DateTimeBuilder dp = new DateTimeBuilder(getContext(), data, item);
			...
			dp.setNeutralButton("确定", new DialogInterface.OnClickListener()
			{
				...
				public void onClick(DialogInterface dialog, int which)
				{
					...
					if(item.isRefreshItem())
						handler.sendMessage(handler.obtainMessage(Constants.CustomGridType.REFRESHITEM, dp.getDatetime()));
