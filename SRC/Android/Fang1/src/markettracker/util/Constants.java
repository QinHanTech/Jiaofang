...
public static String URL="http://www.rymbus.com/fc2/index.php/Api/";
public static String BASEURL="http://www.rymbus.com/fc2/";
	enum ControlType {
	...
	interface DataBaseName {
		@SuppressLint("SdCardPath")
		final static String DATABASE_NAME = "/sdcard/fang//fang1.db";
	}
	...
	interface CurVersion {
		...
		final static String APPNAME = "fang1.apk";
		final static String DOWNLOADURL = "http://www.parrowtech.com/fang1.apk";
	}
